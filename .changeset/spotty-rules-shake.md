...
Make the programmatic entry point browser-safe. `@eluan/theme-generator` can now be imported in a client component and used to generate themes live from user-picked accents — no bundler shims, no Node polyfills.
