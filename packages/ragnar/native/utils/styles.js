...
export function createThemedStyles(styleCreator) {
    ...
    const lightStyles = StyleSheet.create(styleCreator({ colors, spacing, radii, fontSizes, fontWeights }, "light"));
    const darkStyles = StyleSheet.create(styleCreator({ colors: darkColors, spacing, radii, fontSizes, fontWeights }, "dark"));
    return (scheme = "light") => {
