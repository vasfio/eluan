...
import { Skeleton, SkeletonText, SkeletonAvatar, SkeletonCard, SkeletonListItem, SkeletonGroup, } from "./Skeleton";
const meta = {
...
export const ProfileSkeleton = {
    render: () => (<View style={{ alignItems: "center", gap: 16 }}>
