...
export const Sizes = {
    render: () => (<View style={{ flexDirection: "row", alignItems: "center", gap: 24 }}>
...
export const PulseLoaders = {
    render: () => (<View style={{ flexDirection: "row", alignItems: "center", gap: 32 }}>
      <PulseLoader size={32}/>
      <PulseLoader size={48}/>
...
export const Overlay = {
    render: () => (<View style={{ position: "relative", height: 200 }}>
      <View style={{
            padding: 16,
            backgroundColor: "#f4f4f5",
            borderRadius: 12,
