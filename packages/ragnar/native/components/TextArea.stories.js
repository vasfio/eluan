...
export const WithCharacterCount = {
    render: function CharacterCountStory() {
        ...
        return (<TextArea label="Tweet" placeholder="What's happening?" value={value} onChangeText={setValue} maxLength={280} showCount/>);
    },
};
...
export const AutoGrow = {
    render: function AutoGrowStory() {
        ...
        <TextArea label="Auto-growing TextArea" placeholder="Start typing and watch it grow..." value={value} onChangeText={setValue} autoGrow rows={2} maxHeight={200} helperText="This textarea will grow as you type"/>
...
export const ContactForm = {
    render: function ContactFormStory() {
        ...
        <TextArea label="Message" placeholder="How can we help you?" value={message} onChangeText={setMessage} rows={5} maxLength={500} showCount/>
...
export const FeedbackForm = {
    render: function FeedbackFormStory() {
        ...
        <TextArea placeholder="Tell us what you think..." value={feedback} onChangeText={setFeedback} rows={4} autoGrow/>

        <Button disabled={feedback.length < 10} onPress={() => setSubmitted(true)}>
          Submit Feedback
        </Button>

        {feedback.length > 0 && feedback.length < 10 && (<Text style={{ color: "#f59e0b", fontSize: 12 }}>
...
export const CodeInput = {
    render: function CodeInputStory() {
        ...
        <TextArea label="Code Snippet" value={code} onChangeText={setCode} rows={6} style={{
                fontFamily: "monospace",
                fontSize: 14,
            }} autoGrow maxHeight={300}/>
        <View style={{
                padding: 12,
...
export const NotesTaking = {
    render: function NotesStory() {
        ...
        <TextArea placeholder="Start writing your notes..." value={notes} onChangeText={setNotes} rows={8} autoGrow maxHeight={400}/>
