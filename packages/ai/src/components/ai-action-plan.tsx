...
const statusIconColorMap = {
  queued: "text-[color:var(--container-fg-alt)] opacity-50",
  running: "text-[color:var(--informative-fg-strong)] animate-spin",
  complete: "text-[color:var(--positive-fg-strong)]",
  error: "text-[color:var(--destructive-fg-strong)]",
  awaiting: "text-[color:var(--cautionary-fg-strong)]",
} as const
        ...
        <TimelineContent>
          <div className="flex flex-row items-start justify-between">
            <div className="flex flex-col">
              ...
              {description && (
                <TimelineDescription className="mt-0 text-[length:var(--font-size-xs)]">
                  {description}
                </TimelineDescription>
              )}
            </div>
            {duration && (
              <TimelineTime className="text-[length:var(--font-size-xs)] shrink-0 ml-[var(--spacing-sm)]">
                {duration}
              </TimelineTime>
            )}
          </div>
