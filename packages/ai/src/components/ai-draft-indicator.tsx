...
import { ToggleGroup, ToggleGroupItem, Badge } from "@vasf/ragnar-core"

const aiDraftIndicatorVariants = cva(
  "inline-flex items-center gap-[var(--spacing-xxs)] rounded-[var(--curves-xl)] text-[length:var(--font-size-sm)] font-medium transition-colors",
  {
    variants: {
      variant: {
...
>(
  (
    ...
    const modeClasses = isDraft
      ? "border border-dashed border-[var(--cautionary-border)] bg-[var(--cautionary-bg-alt)] text-[color:var(--cautionary-fg-strong)]"
      : "border border-solid border-[var(--positive-border)] bg-[var(--positive-bg-alt)] text-[color:var(--positive-fg-strong)]"
