...
import { Collapsible, CollapsibleTrigger, CollapsibleContent, Button } from "@vasf/ragnar-core"
        ...
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              className="justify-start gap-[var(--spacing-xs)] text-[color:var(--container-fg-alt)] hover:text-[color:var(--container-fg)] px-0 h-auto py-[var(--spacing-xxs)]"
            ...
            >
              ...
              {duration && (
                <span className="text-[length:var(--font-size-xs)] text-[color:var(--container-fg-alt)] ml-auto">
                  {duration}
                </span>
              )}
            </Button>
  ...
  ({ className, tool, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex flex-row items-start gap-[var(--spacing-xs)] py-[var(--spacing-xxs)] text-[length:var(--font-size-sm)] text-[color:var(--container-fg-alt)]",
          className
        )}
        {...props}
      >
        {IconComponent && (
          <IconComponent className="h-[var(--size-xxs)] w-[var(--size-xxs)] shrink-0 mt-0.5 text-[color:var(--container-fg-alt)]" />
        )}
