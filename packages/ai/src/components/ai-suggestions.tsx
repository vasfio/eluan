...
const aiSuggestionItemVariants = cva(
  "inline-flex items-center gap-[var(--spacing-xs)] rounded-[var(--curves-md)] font-normal transition-colors focus:outline-none focus:ring-1 focus:ring-[var(--interactive-border-alt)] focus:ring-offset-1 cursor-pointer disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "border border-[var(--container-border-alt)] bg-transparent text-[color:var(--container-fg-alt)] hover:bg-[var(--interactive-bg-alt2)]",
        filled:
          "border border-transparent bg-[var(--interactive-bg-alt2)] text-[color:var(--container-fg-alt)] hover:bg-[var(--interactive-bg-alt)]",
        ghost:
          "border border-transparent bg-transparent text-[color:var(--container-fg-alt)] hover:text-[color:var(--container-fg)]",
      },
      size: {
        ...
        lg: "px-[var(--spacing-md)] py-[var(--spacing-sm)] text-[length:var(--font-size-base)]",
      },
    },
    defaultVariants: {
      variant: "default",
