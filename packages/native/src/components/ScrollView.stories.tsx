...
export const Default: Story = {
  render: () => (
    <View style={{ height: 300, borderWidth: 1, borderColor: "#e4e4e7", borderRadius: 8 }}>
...
export const WithPadding: Story = {
  render: () => (
    <View style={{ height: 250, borderWidth: 1, borderColor: "#e4e4e7", borderRadius: 8 }}>
...
export const HideIndicators: Story = {
  render: () => (
    <View style={{ height: 200, borderWidth: 1, borderColor: "#e4e4e7", borderRadius: 8 }}>
...
export const HorizontalWithSnapping: Story = {
  render: () => (
...
export const KeyboardAware: Story = {
  render: () => (
    <View style={{ height: 350, borderWidth: 1, borderColor: "#e4e4e7", borderRadius: 8 }}>
