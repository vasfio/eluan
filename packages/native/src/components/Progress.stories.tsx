  ...
  render: () => (
    <View style={{ gap: 16 }}>
      ...
      <Progress
        ...
        label="XP Progress"
        showValue
        formatValue={(value, max) => `${value.toLocaleString()} / ${max.toLocaleString()} XP`}
      />
    </View>
  ),
}
...
export const CircularWithContent: Story = {
  render: () => (
    ...
    return (
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
          ...
          {progress === 100 && (
            <Text style={{ color: "#22c55e", fontWeight: "500" }}>✓</Text>
          )}
        </View>
        ...
        {uploading ? (
          ...
          <Text style={{ color: "#22c55e", fontSize: 14 }}>Upload complete!</Text>
        ) : (
          <Button onPress={startUpload}>Upload File</Button>
        )}
      </View>
    )
  },
