...
export const Default: Story = {
  render: () => (
    <SafeAreaView style={{ backgroundColor: "#f4f4f5" }}>
...
export const SelectiveEdges: Story = {
  render: () => (
    <View style={{ gap: 16 }}>
...
export const PaddingMode: Story = {
  render: () => (
    <SafeAreaView mode="padding" style={{ backgroundColor: "#e4e4e7" }}>
      <View style={{ padding: 20 }}>
...
export const CustomBackground: Story = {
  render: () => (
    <SafeAreaView backgroundColor="#3b82f6">
      <View style={{ padding: 20 }}>
...
export const CustomInsets: Story = {
  render: () => (
    <SafeAreaProvider insets={{ top: 60, bottom: 40 }}>
...
export const AppLayout: Story = {
  render: () => (
    <View style={{ height: 500, backgroundColor: "#18181b" }}>
