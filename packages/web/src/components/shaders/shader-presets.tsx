  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          {title && (
            <h1 className="max-w-4xl text-[length:var(--font-size-4xl)] font-bold tracking-tight text-white sm:text-[length:var(--font-size-5xl)] md:text-6xl lg:text-7xl">
              {title}
            </h1>
          )}
          {subtitle && (
            <p className="mt-[var(--spacing-md)] max-w-2xl text-[length:var(--font-size-lg)] text-white/80 sm:text-[length:var(--font-size-xl)] md:text-[length:var(--font-size-2xl)]">
              {subtitle}
            </p>
          )}
          {children}
