      ...
      <div className="absolute bottom-4 left-4 right-4 rounded-[var(--curves-lg)] border border-[color:var(--container-border-alt)] bg-[var(--container-bg)] p-[var(--spacing-md)] shadow-lg sm:left-auto sm:right-4 sm:max-w-xs">
        <div className="space-y-[var(--spacing-sm)]">
          <div className="flex items-start gap-[var(--spacing-sm)]">
            <svg
              className="mt-[var(--spacing-xxs)] h-[var(--size-xs)] w-[var(--size-xs)] shrink-0 text-[color:var(--container-fg-alt)]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
            ...
            <p className="text-[length:var(--font-size-sm)] text-[color:var(--container-fg)]">{address}</p>
          </div>

          {phone && (
            <div className="flex items-center gap-[var(--spacing-sm)]">
              <svg
                className="h-[var(--size-xs)] w-[var(--size-xs)] shrink-0 text-[color:var(--container-fg-alt)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
              ...
              <a
                href={`tel:${phone}`}
                className="text-[length:var(--font-size-sm)] text-[color:var(--container-fg)] hover:underline"
              >
                {phone}
              </a>
            </div>
          ...
          {hours && (
            <div className="flex items-center gap-[var(--spacing-sm)]">
              ...
              <p className="text-[length:var(--font-size-sm)] text-[color:var(--container-fg-alt)]">{hours}</p>
            </div>
          )}
          ...
          {directionsUrl && (
            <a
              ...
              className="mt-[var(--spacing-sm)] inline-flex w-full items-center justify-center gap-[var(--spacing-sm)] rounded-[var(--curves-md)] bg-[var(--action-primary-bg)] px-[var(--spacing-md)] py-[var(--spacing-sm)] text-[length:var(--font-size-sm)] font-medium text-[color:var(--action-primary-fg)] transition-colors hover:bg-[var(--action-primary-bg)]"
            >
              Get Directions
              <svg
