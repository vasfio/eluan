...
const aiNudgeVariants = cva(
  "flex items-center gap-[var(--spacing-sm)] text-[var(--font-size-sm)] font-normal",
  {
    variants: {
      variant: {
        inline:
          "relative w-full rounded-[var(--curves-sm)] border border-[var(--informative-border)] bg-[var(--informative-bg-alt,var(--informative-bg))] px-[var(--spacing-sm)] py-[var(--spacing-xs)] text-[var(--informative-fg)] [&_svg]:text-[var(--informative-fg)]",
        floating:
          "absolute z-50 rounded-[var(--curves-md)] border border-[var(--informative-border)] bg-[var(--informative-bg-alt,var(--informative-bg))] px-[var(--spacing-sm)] py-[var(--spacing-xs)] text-[var(--informative-fg)] shadow-lg [&_svg]:text-[var(--informative-fg)]",
        subtle:
          "text-[var(--foregrounds-tertiary)] [&_svg]:text-[var(--informative-fg)]",
      },
    },
    defaultVariants: {
      variant: "inline",
