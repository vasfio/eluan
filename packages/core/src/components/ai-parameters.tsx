  ...
  (
    ...
    >
      <div className="flex items-center justify-between">
        <label className="text-[var(--font-size-sm)] font-medium text-[var(--container-fg)]">
          {label}
        </label>
        {showValue && (
          <span className="text-[var(--font-size-xs)] text-[var(--container-fg-alt)] tabular-nums">
            {value}
          </span>
        )}
      </div>
  ...
  (
    ...
    >
      <div className="flex flex-col gap-[var(--spacing-xxs)]">
        <span className="text-[var(--font-size-sm)] font-medium text-[var(--container-fg)]">
          {label}
        </span>
        {description && (
