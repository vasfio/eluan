        ...
        <div ref={ref} className={cn("w-full", className)} {...props}>
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              className="flex w-full items-center justify-start gap-[var(--spacing-xs)] py-[var(--spacing-xs)] text-[var(--font-size-xs)] font-medium text-[var(--container-fg-alt)] transition-colors hover:text-[var(--container-fg)]"
            >
              <ChevronDown
                className={cn(
            ...
            <div className="bg-[var(--container-bg-alt)] rounded-[var(--curves-sm)] p-[var(--spacing-sm)] mt-[var(--spacing-xxs)]">
              ...
              {showCopy && (
                <Button
                  ...
                  size="sm"
                  onClick={handleCopy}
                  className="mt-[var(--spacing-sm)] inline-flex items-center gap-[var(--spacing-xxs)] text-[var(--font-size-xs)] text-[var(--container-fg-alt)] hover:text-[var(--container-fg)]"
                >
...
>(({ className, label, value, children, ...props }, ref) => (
  <div
    ...
    {...props}
  >
    <span className="text-[var(--container-fg-alt)] text-[var(--font-size-xs)] shrink-0">
      {label}
    </span>
    <span className="text-[var(--container-fg)] text-[var(--font-size-xs)] text-right">
      {value ?? children}
    </span>
  </div>
))
