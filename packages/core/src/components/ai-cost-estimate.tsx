...
const aiCostEstimateVariants = cva("", {
  variants: {
    variant: {
      inline:
        "inline-flex items-center gap-[var(--spacing-xxs)] text-[var(--font-size-xs)] text-[var(--container-fg-alt)]",
      detailed:
        "flex flex-col gap-[var(--spacing-xs)] bg-[var(--container-bg-alt)] rounded-[var(--curves-sm)] p-[var(--spacing-sm)] text-[var(--font-size-sm)]",
    },
    icon: {
      coins: "",
      zap: "",
      ...
      return (
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <span className="inline-flex items-center gap-[var(--spacing-xxs)] font-medium text-[var(--container-fg)]">
            ...
            <span className="font-medium text-[var(--container-fg)] tabular-nums">
              {cost}
              {unit && (
                <span className="ml-[var(--spacing-xxs)] text-[var(--container-fg-alt)] font-normal">
                  {unit}
                </span>
              )}
            </span>
          ...
          {breakdown && breakdown.length > 0 && (
            <div className="flex flex-col gap-[var(--spacing-xxs)] border-t border-[var(--container-border-alt)] pt-[var(--spacing-xs)]">
              {breakdown.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between text-[var(--font-size-xs)] text-[var(--container-fg-alt)]"
                >
