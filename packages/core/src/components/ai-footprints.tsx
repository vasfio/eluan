    ...
    return (
      <TimelineItem ref={ref} className={cn("group", className)} {...props}>
        ...
        <TimelineContent>
          ...
          <div className="flex flex-wrap items-center gap-[var(--spacing-xs)] text-[var(--font-size-xs)] text-[var(--container-fg-alt)] group-[[data-compact]]/root:hidden">
          ...
          {details && (
            <div>
              <button
                ...
                className="text-[var(--font-size-xs)] text-[var(--informative-fg-strong)] hover:underline"
              >
