          ...
          <SelectContent>
            {models.map((model) => (
              ...
              >
                ...
                {model.description && (
                  <span className="block text-[var(--font-size-xs)] text-[var(--container-fg-alt)]">
                    {model.description}
                  </span>
                )}
                {model.indicator && (
                  <span className="block text-[var(--font-size-xs)] text-[var(--container-fg-alt)] opacity-75">
                    {model.indicator}
                  </span>
                )}
              </SelectItem>
