...
const meta: Meta<typeof AIModelSelector> = {
  title: "Components/AI Model Selector",
  ...
  parameters: {
    docs: {
      description: {
        component: `
A dropdown selector that lets users choose between available AI models, with support for badges, descriptions, indicators, icons, and disabled options.

**Import**
\`\`\`tsx
import { AIModelSelector } from "@vasf/ragnar-core"
\`\`\`
...
\`\`\`
  ...
  argTypes: {
    models: {
      description: "Array of AIModelOption objects defining the available models.",
    },
    value: {
    ...
    size: {
      description: 'Trigger size: `"default"` or `"sm"`.',
    },
  },
}
