...
const aiCaveatVariants = cva(
  "inline-flex items-center gap-[var(--spacing-xs)] text-[var(--font-size-xs)] text-[var(--container-fg-alt)]",
  {
    variants: {
      variant: {
        subtle: "",
        ...
        warning:
          "border border-[var(--cautionary-border)] rounded-[var(--curves-sm)] p-[var(--spacing-xs)] bg-[var(--cautionary-bg-alt,var(--container-bg-alt))] text-[var(--cautionary-fg-strong)]",
      },
    },
    defaultVariants: {
      variant: "subtle",
