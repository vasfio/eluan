...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-[var(--font-size-sm)] font-normal ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-400 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: "h-[var(--size-md)] rounded-md px-3 text-[var(--font-size-xs)]",
        lg: "h-[var(--size-xl)] rounded-md px-8 text-[var(--font-size-base)]",
