...
const variantColorOverrides = {
  stop: "",
  pause: "bg-[var(--cautionary-bg)] text-[var(--cautionary-fg)] hover:bg-[var(--cautionary-bg-hover)] border-transparent",
  resume: "bg-[var(--positive-bg)] text-[var(--positive-fg)] hover:bg-[var(--positive-bg-hover)] border-transparent",
  regenerate: "",
} as const
